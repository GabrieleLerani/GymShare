...
init {
    ...
    fun onManageGeneratePlanEvent(event: ManagePlanEvent) {
        when (event) {
            ...
            is ManagePlanEvent.DeletePlan -> TODO()
            is ManagePlanEvent.SelectPlan -> TODO()
            is ManagePlanEvent.SelectShowDialogPlan -> TODO()
        }
    }
